...
<!-- YOUTUBE:START -->
- [How to uninstall yarn on Linux mint | Remove yarn from Linux mint](https://www.youtube.com/watch?v=iudSKjy_0A8)
- [How to install yarn on Linux Mint | Install yarn dependencies](https://www.youtube.com/watch?v=XlxX6tpCKdI)
- [How to install Visual Studio Code on Linux Mint | Install VS Code on Linux Mint 20.2](https://www.youtube.com/watch?v=TycxknDhzAg)
